...
export default function HalfPayTable() {
    ...
    return (
        <div className="overflow-x-auto">
            <table className="table table-zebra xs:table-md">
                <tbody >
                    <tr>
                        {
                            ...
                            return (
                                <tr key={i + "_hpr"} className="p-4 text-white text-xl text-center font-bold border border-slate-300">
                                    ...
                                    <td className="border border-slate-300">
                                        <textarea className="textarea textarea-lg xs:textarea-md w-full max-w-2xl h-full min-h-[300px] xs:min-h-[100px] text-red-500" defaultValue={row ? row[1] : ""} onChange={(ev) => setHPN(ev.target.value, row[0])}></textarea>
                                    </td>
